...
<body>
    <div id="container">
        <form action="/thinkphp/index.php/Admin/Public/checkLogin" method="post">
        <div id="bd">
            <div class="login1">
                ...
                <div class="login-input">
                    ...
                    <p class="yzm ue-clear">
                        ...
                        <cite><img style="margin-left: 2px" src="/thinkphp/index.php/Admin/Public/captcha"
                        onclick="this.src='/thinkphp/index.php/Admin/Public/captcha/t/'+Math.random()"></cite>
                    </p>
                </div>
